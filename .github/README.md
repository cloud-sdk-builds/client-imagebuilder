...
[`@aws-sdk/client-imagebuilder`](https://www.npmjs.com/package/@aws-sdk/client-imagebuilder/v/3.310.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-imagebuilder@3.310.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4h0EzBWe0ejTFR0MCRfWLd/Ubl+IzpMjpqWMtcppwnLVQsx0QO091NCcWtbB9SWO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-imagebuilder": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-imagebuilder@3.310.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-imagebuilder@3.310.0/index.min.mjs": "sha384-4h0EzBWe0ejTFR0MCRfWLd/Ubl+IzpMjpqWMtcppwnLVQsx0QO091NCcWtbB9SWO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-imagebuilder/blob/refs/tags/3.310.0/LICENSE
```
